  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      try {
        ...
        setError("Failed to parse PDF data: " + (parseErr instanceof Error ? parseErr.message : String(parseErr)));
        return;
      }
  ...
  return (
    <Box sx={{ mt: 3, mb: 3, p: 2, border: '1px dashed grey', borderRadius: '4px' }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Input
          type="file"
          inputProps={{ accept: '.pdf', id: 'pdf-upload-input', name: 'pdfUploadInput' }}
