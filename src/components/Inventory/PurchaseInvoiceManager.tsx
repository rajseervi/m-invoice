...
export default function PurchaseInvoiceManager({ onStatsUpdate }: PurchaseInvoiceManagerProps) {
  ...
  const loadStats = async () => {
    try {
      const statistics = await PurchaseInvoiceService.getPurchaseInvoiceStatistics();
      setStats(statistics);
    } catch (error) {
  ...
  const handleDeleteInvoice = async () => {
    ...
    try {
      await PurchaseInvoiceService.deletePurchaseInvoice(invoiceToDelete);
    ...
    <Box>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        ...
        <Button
          variant="contained"
          startIcon={<AddIcon />}
          onClick={() => router.push('/inventory/purchase-invoices/new')}
        >
      ...
      >
        <MenuItem onClick={() => {
          router.push(`/inventory/purchase-invoices/${selectedInvoiceId}`);
          handleMenuClose();
        }}>
          <ListItemIcon>
        ...
        <MenuItem onClick={() => {
          router.push(`/inventory/purchase-invoices/${selectedInvoiceId}/edit`);
          handleMenuClose();
        }}>
          <ListItemIcon>
        ...
        <MenuItem onClick={() => {
          router.push(`/inventory/purchase-invoices/${selectedInvoiceId}/payment`);
          handleMenuClose();
        }}>
          <ListItemIcon>
