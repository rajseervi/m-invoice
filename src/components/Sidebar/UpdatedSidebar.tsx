...
const UpdatedSidebar: React.FC<UpdatedSidebarProps> = React.memo(({
  onToggle,
  isOpen = true,
  onMobileClose,
  userAvatar,
  ...
  // Enhanced navigation sections with backup module
      ...
      items: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              keywords: ['profit', 'loss', 'financial', 'performance'],
              category: 'secondary',
              isNew: true
            },
            {
              ...
              description: "Data quality monitoring and fixes",
              keywords: ['data', 'quality', 'monitoring', 'fixes'],
              category: 'secondary',
              isNew: true
            },
            {
              ...
              description: "HSN code analysis and tax reports",
              keywords: ['hsn', 'tax', 'analysis', 'gst'],
              category: 'secondary'
            }
          ]
        }
      ...
      items: [
        {
          ...
          keywords: ['backup', 'restore', 'data', 'export', 'import', 'safety'],
          category: 'admin',
          isNew: true
        }
      ]
...
UpdatedSidebar.displayName = 'UpdatedSidebar';
