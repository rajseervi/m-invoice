...
export default function EnhancedInvoiceCreation({ onCreateInvoice }: EnhancedInvoiceCreationProps) {
    ...
    <Container maxWidth="xl">
      ...
      >
        ...
        <MotionBox
          ...
          sx={{ mb: 6 }}
        >
          <Card sx={{ background: alpha(theme.palette.background.paper, 1), backdropFilter: 'blur(1px)' }}>
            <CardContent sx={{ p: 4 }}>
