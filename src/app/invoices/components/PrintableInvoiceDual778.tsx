        ...
        >
          <Grid container spacing={0.3}>
            ...
            <Grid item xs={6}>
              ...
              <Box style={{ border: '2px solid #000', borderRadius: '8px', padding: '0.2rem 0.5rem', marginBottom: '0.2rem' }}>
                <Typography variant="subtitle2" color="text.secondary" sx={{ fontSize: '0.65rem', mb: 0.1 }}>
                  INVOICE INFO
                </Typography>
                <Grid  spacing={1.2}>
                  ...
                  <Grid item xs={7}>
                    <Typography variant="body2" style={{border:'2px dotted',borderRadius:'20px',}} py={.5} px={1} fontWeight="medium" sx={{ fontSize: '0.7rem', lineHeight: 2.1 }}>{invoice.invoiceNumber}</Typography>
                  </Grid>
                  </Grid>
